<?php
    ...
    $patients = mysqli_fetch_all($queryPatient, MYSQLI_ASSOC);

	if(isset($_POST["search"])){
		$search = $_POST["search"];
		$sqlSearch = "SELECT * FROM patient WHERE PatientID = '$search'";
...
<body>
	<div id="mySidenav" class="sidenav">
		...
		<a href="patient.php" class="active">Patient</a>
		...
		<div class="container">
			...
			<table class="table table-bordered border-secondary">
                ...
                <tr>
                    ...
                    <td><?php echo htmlspecialchars($patient['RegisterDate'])?></td>
                ...
                <?php } } else { foreach($resultSearch as $searchs) { ?>
                    ...
                    <td><?php echo htmlspecialchars($searchs['RegisterDate'])?></td>
