<?php
	...
	$sqlMed = "SELECT * FROM medicine_supply";
	$query2 = mysqli_query($con, $sqlMed);
	$medicine = mysqli_fetch_all($query2, MYSQLI_ASSOC);

	if(isset($_POST["search"])){
        $search = $_POST["search"];
        $sqlSearch = "SELECT * FROM medicine_supply WHERE MedicineSupplyID = '$search'";
...
<body>
	<div id="mySidenav" class="sidenav">
		...
		<a href="medicine_supply.php" class="active">Medicine Supply</a>
	...
	<div id="main">
		<div class="container">
			...
			<a href="" style="text-decoration: none">Add Medicine Supply +</a>
            <br><br>
			<table class="table table-bordered border-secondary">
				...
				?>
					<tr>
						<td><?php echo htmlspecialchars($med['MedicineSupplyID'])?></td>
						<td><?php echo htmlspecialchars($med['MedicineName'])?></td>
						<td><?php echo htmlspecialchars($med['QuantityOnHand'])?></td>
						<td><?php echo htmlspecialchars($med['QuantityOrdered'])?></td>
						<td><?php echo htmlspecialchars($med['Dosage'])?></td>
						<td><?php echo htmlspecialchars($med['DateOrdered'])?></td>
						<td><?php echo htmlspecialchars($med['DateReceived'])?></td>
						<td><?php echo htmlspecialchars($med['ExpirationDate'])?></td>
						<td><?php echo htmlspecialchars($med['StaffID'])?></td>
						<td><?php echo htmlspecialchars($med['SupplierID'])?></td>
					</tr>
				<?php } } else { foreach($resultSearch as $searchs) {?>
					<tr>
						<td><?php echo htmlspecialchars($searchs['MedicineSupplyID'])?></td>
						<td><?php echo htmlspecialchars($searchs['MedicineName'])?></td>
						<td><?php echo htmlspecialchars($searchs['QuantityOnHand'])?></td>
						<td><?php echo htmlspecialchars($searchs['QuantityOrdered'])?></td>
						<td><?php echo htmlspecialchars($searchs['Dosage'])?></td>
						<td><?php echo htmlspecialchars($searchs['DateOrdered'])?></td>
						<td><?php echo htmlspecialchars($searchs['DateReceived'])?></td>
						<td><?php echo htmlspecialchars($searchs['ExpirationDate'])?></td>
						<td><?php echo htmlspecialchars($searchs['StaffID'])?></td>
						<td><?php echo htmlspecialchars($searchs['SupplierID'])?></td>
					</tr>
				<?php }} ?> 
            </table>
